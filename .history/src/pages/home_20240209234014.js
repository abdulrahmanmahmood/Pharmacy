...
function Home() {
  ...
  return (
<div>
  <div className=" mx-auto items-center text-center w-[100%] h-full bg-red-700 absolute z-50 lg:hidden ">

    <h3 className="my-auto items-center text-center text-nowrap">We recommend to Use Our Mobile Application</h3>
