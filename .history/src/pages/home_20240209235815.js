...
function Home() {
  ...
  return (
<div className="relative items-center text-center mx-auto">
  <div className=" items-center text-center w-[90%] ml-auto h-[90vh] my-10 rounded  bg-slate-400 absolute z-50 md:hidden ">

    <h3 className="mt-60 items-center text-center text-rap">We recommend to Use Our Mobile Application</h3>
