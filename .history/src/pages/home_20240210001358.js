...
<div className="relative items-center text-center ">
  <div className=" items-center text-center w-[90%] ml-5 sm:ml-10 h-[90vh] my-10 rounded-2xl text-white  bg-slate-400 absolute z-50 md:hidden ">

    <h3 className="py-20  items-center text-center text-rap  px-2 ">We Recommend to Use Our Mobile Application</h3>
