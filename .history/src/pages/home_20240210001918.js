...
<div className="relative items-center text-center ">
  <div className=" items-center text-center w-[90%] ml-5 sm:ml-10 h-[90vh] mt-10 rounded-2xl text-white  bg-slate-400 absolute z-50 md:hidden fixed">
  ...
  <div className="w-20 h-20 mx-auto items-center mt-10 " onClick={gotoAppStore}>
