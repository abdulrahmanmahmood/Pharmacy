...
function Home() {
  ...
  return (
<div className=" items-center text-center fixed">
  <div className=" items-center text-center w-[90%]  h-[90vh] mt-10 rounded-2xl text-green-500  bg-white  z-50 md:hidden ">

    <h3 className="py-10  items-center text-center text-rap mt-10   px-2 ">Download now from the App Store or Google Play Store.</h3>
