...
<div className=" items-center text-center fixed">
  <div className=" outline-dashed w-full  h-[90vh] mt-10 text-green-500  bg-white  z-50 md:hidden ">
  ...
  <div className=" h-20 mx-auto items-center mt-10 " onClick={gotoAndroidStore}>
